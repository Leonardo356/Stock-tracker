...
usernameStore.setState('username', '');
...
confirmPasswordStore.setState('confirmPassword', '');
...
const SignInTitle: React.FC = () => {
    return(
        <>
          <h1 className="text-[2rem] textShadow font-bold">Sign Up!</h1>
        </>
    );
};
...
const EmailInp: React.FC = () => {
    ...
    return(
        <>
            <form className="w-[60%] flex bg-babyBlue/20 border-[1px] rounded-[.5rem]">
                  <input
...
const UserNameInp: React.FC = () => {

    // eslint-disable-next-line
    const [username, setUsername] = usernameStore.useState('username');
...
const ConfirmPasswordInp: React.FC = () => {

    // eslint-disable-next-line
    const [confirmPassword, setConfirmPassword] = confirmPasswordStore.useState('confirmPassword');
...
const SignInButton: React.FC = () => {
    ...
    const signUpNewUser: ReactEventHandler = () => {
        username === ''
        ? toast.error('Invalid username')
        : username.length < 5
        ? toast.error('Minimum of 5 characters')
        : username.length > 15
        ? toast.error('Maximum of 15 characters') 
...
const GoogleBtn: React.FC = () => {
    ...
    const signUpWithGoogle: ReactEventHandler = () => {
